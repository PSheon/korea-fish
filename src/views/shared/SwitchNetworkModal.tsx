...
// // ** Ethereum Configs
// import { ETHEREUM_CONFIG } from 'src/configs/ethereum'
...
//     <Dialog
//       fullWidth
//       open={user.role !== 'Public' && chain?.id !== ETHEREUM_CONFIG.useChain.id}
//       maxWidth='sm'
//       scroll='body'
...
//                 Switch Network
//               </Typography>
//               <Typography variant='body1'>Our contract running on Ethereum Sepolia</Typography>
//             </Box>
//           </Grid>
...
//                 variant='contained'
//                 onClick={() => switchNetwork(ETHEREUM_CONFIG.useChain.id)}
//               >
...
//           </Grid>
//           <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'center' }}>
//             <Button onClick={handleLogout} variant='text' size='small' color='warning'>
//               Sign Out
//             </Button>
//           </Grid>
//           <Grid item xs={12}>
